...
<div class="container-fluid hero-header">
    ...
    <img src="uploads/ga1.png" 
         class="w-100" 
         alt="Left Image" 
         style="height: 300px; border-radius: 8px 0 0 8px;
                animation: flipHorizontal 4s infinite ease-in-out;
                transform-origin: center;">
    <style>@keyframes flipHorizontal{0%{transform:scaleX(1);}25%{transform:scaleX(-1);}75%{transform:scaleX(-1);}100%{transform:scaleX(1);}}</style>
</div>
         ...
         <div class="col-md-3 d-none d-md-block">
    <img src="uploads/ga2.jpg" 
         class="w-100" 
         alt="Right Image" 
         style="height: 300px; object-fit: cover; border-radius: 0 3px 3px 0;
                animation: flipHorizontal 4s infinite ease-in-out;
                transform-origin: center;">
    <style>@keyframes flipHorizontal{0%{transform:scaleX(1);}25%{transform:scaleX(-1);}75%{transform:scaleX(-1);}100%{transform:scaleX(1);}}</style>
</div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <div class="d-flex">
                    <!-- Image Column -->
                    <div class="flex-shrink-0 me-4" style="width: 290px; height: auto;">
                        <img src="uploads/ceo1.jpg" alt="About MEC College" class="img-fluid" style="width: 90%; height: 90%;">
                    </div>

                    <!-- Text Column -->
                    <div class="flex-grow-1">
                <h1 class="about-title" data-aos="zoom-in" data-aos-delay="20">Message From CEO</h1><h5>Mr. Iftikhar Ahmed</h5>
                        <p class="mb-4" style="height: 100%; text-align: justify; text-justify: inter-word;">
                            Allied Health Professionals are recognized as vital members of the health team. While our college comprises different medical technologies at different levels, we share the common goal of medical excellence in Allied Health Sciences. Our aim is not only to equip our students with professional skills but also with critical thinking, problem-solving skills, social ethics, and religious values. Nelson Mandela rightly said, "Education is the most powerful weapon you can use to change the world." If there is one thing that can change the world, it is education. In this pursuit of excellence, I appreciate the co-operation and support from our parent fraternity. I also laud the relentless efforts of our teachers for giving their best in bringing out the best in our students.
                        </p>
                    </div>
                </div>
            </div>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="about-title" data-aos="zoom-in" data-aos-delay="20 ">Our Programs</h1>
        </div>
        <div class="row g-4">
...
<div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
    <h1 class="about-title" data-aos="zoom-in" data-aos-delay="20">Affiliation</h1>
</div>
...
<div class="d-flex justify-content-center wow fadeInUp" data-wow-delay="0.1s">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="about-title" data-aos="zoom-in" data-aos-delay="20">Contact Us</h1>
            </div>
            <div class="row g-4">
...
<div class="container-xxl py-5">
    <div>
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h1 class="about-title" data-aos="zoom-in" data-aos-delay="20">Our Location</h1>
        </div>
